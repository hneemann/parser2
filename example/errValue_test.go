...
func TestErrValue(t *testing.T) {
	tests := []struct {
		...
		{exp: "(10.0+err(2.0))+2.0", res: ErrValue{12, 2}},
		{exp: "2.0+(10.0+err(2.0))", res: ErrValue{12, 2}},
		{exp: "(10+err(2))-2", res: ErrValue{8, 2}},
		{exp: "2-(10+err(2))", res: ErrValue{-8, 2}},
		{exp: "(10.0+err(2.0))-2.0", res: ErrValue{8, 2}},
		{exp: "2.0-(10.0+err(2.0))", res: ErrValue{-8, 2}},
		{exp: "(10+err(2))*2", res: ErrValue{20, 4}},
		{exp: "2*(10+err(2))", res: ErrValue{20, 4}},
		{exp: "(10+err(2))*2.0", res: ErrValue{20, 4}},
		{exp: "2.0*(10+err(2))", res: ErrValue{20, 4}},
		{exp: "(10+err(2))/2", res: ErrValue{5, 1}},
		{exp: "10/(2+err(1))", res: ErrValue{5, 5}},
		{exp: "(10+err(2))/2.0", res: ErrValue{5, 1}},
		{exp: "10.0/(2+err(1))", res: ErrValue{5, 5}},
		...
		{exp: "(1+-2)=4.0", res: value.Bool(false)},
		{exp: "(1+-2)=2.0", res: value.Bool(true)},
		{exp: "4.0=(1+-2)", res: value.Bool(false)},
		{exp: "2.0=(1+-2)", res: value.Bool(true)},

		{exp: "(1+-2)=(6+-2)", res: value.Bool(false)},
		{exp: "(6+-2)=(1+-2)", res: value.Bool(false)},
		...
		{exp: "(1+-2)<4.1", res: value.Bool(true)},
		{exp: "-2.1<(1+-2)", res: value.Bool(true)},
		{exp: "(1+-2)<2.9", res: value.Bool(false)},
		{exp: "0.9<(1+-2)", res: value.Bool(false)},
		{exp: "(1+-2)<4", res: value.Bool(true)},
		{exp: "-2<(1+-2)", res: value.Bool(true)},
	}
